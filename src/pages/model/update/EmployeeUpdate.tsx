...
export default function EmployeeUpdate() {
    ...
    async function onSubmit(values: any, actions: any) {
        ...
        // VALUES OBJECT GELİYOR. SERIALİBLE OLMASI LAZIM.
        //BUNUN İÇİN İLK STRİNG E SONRA JSON PARSE İLE SERİALİZEBLE YAPARSIN.
        //YADA İNİAL VALUE CLASS ININ İÇİNE toJson() diye bir metod yaz
        //SANA OBJE DÖNSÜN. BU DAHA İYİ BİR ÇÖZÜM:
        /*
         toJSON() {
    return {
      name: this.name,
